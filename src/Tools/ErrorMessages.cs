...
public static class ErrorMessages {
    ...
    public const string StockAmountCannotBeNegative = "Stock weight cannot be negative, If you want to reduce stock use reduce stock endpoint";
    ...
    public const string BillingPartyOpeningBalanceMustBeAtMax2DecimalPlaces = "Opening balance must be at most 2 decimal places";
    public const string BillingPartyVatNumberMustBeBetween5To20Characters = "Vat number must be between 5 to 20 characters (inclusive)";
