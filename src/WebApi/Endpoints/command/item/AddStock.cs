...
public class AddStock : CommandEndPointBase
    ...
    public override async Task<ActionResult> HandleAsync(AddStockRequest request) {
        var commandRequest = new AddStockCommand.Request(request.Id, request.RequestBody.Weight, request.RequestBody.ExpectedValuePerKilo, request.RequestBody.Date);
...
public class AddStockRequest {
    ...
    public record Body(double Weight, double ExpectedValuePerKilo, string Date);
