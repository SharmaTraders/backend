...
public class PurchaseHandlersTests
{
    ...
    public async Task CannotCreatePurchase_With_InvalidBillingPartyId()
    {
        ...
        var handler = new AddPurchaseHandler(repoMock.Object, unitOfWorkMock, billingPartyRepoMock.Object, itemRepoMock.Object);
    ...
    public async Task CannotCreatePurchase_BillingPartyNotFound()
    {
        ...
        var handler = new AddPurchaseHandler(purchaseRepositoryMock.Object, unitOfWorkMock.Object,
            billingPartyRepositoryMock.Object, itemRepositoryMock.Object);
